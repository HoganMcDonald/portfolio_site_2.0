...
app.controller('mainController', function($scope, $http) {
  ...
  $scope.experience = [
    ...
    desccription: 'I chose to attend prime because I knew that I learned best in an immersive environment. Prime o ered the intense experience I knew represented the best entry point into the industry for me.',
    techUsed: ['MEAN Stack', 'SQL', 'SASS', 'JQuery', 'Heroku']},
    {name: '[words] Bookstore',
    desccription: 'I worked in collaboration with business owners to open a first-of-its- kind independent bookstore in the MSP airport.',
